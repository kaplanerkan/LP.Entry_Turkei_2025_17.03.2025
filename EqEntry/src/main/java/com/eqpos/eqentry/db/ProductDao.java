...
public class ProductDao {
    ...
    /**
     * Ürün barkodunun veritabanında mevcut olup olmadığını kontrol eder.
     *
     * @param barcode Kontrol edilecek barkod
     * @param urunIsmi Kontrol edilecek ürün ismi
     * @return true: Ürün mevcut, false: Ürün mevcut değil
     *
     * 18.08.2025 ERKAN
     */
    public static boolean checUrunMevcutmu(String barcode, String urunIsmi) {
        if (Db == null) {
            Db = new Database();
        }
